...
// bundle. null represents the top of funnel ("Potential") - every
// contact tagged "Agent" starts here with no separate value stored,
// until she actually introduces them to the team lead.
export const AGENT_RECRUIT_STAGES: { value: RecruitStage | null; label: string }[] = [
  { value: null, label: "Potential" },

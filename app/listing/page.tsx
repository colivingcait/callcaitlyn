...
export default async function PublicListingsOverviewPage({
  ...
  return (
    <div className="om-page" style={{ fontFamily: "var(--font-om-sans), Archivo, ui-sans-serif, system-ui, sans-serif", background: "#f4f1ec", color: "#211c19", minHeight: "100dvh", overflowX: "clip" }}>
      ...
      <div className="om-gutter" style={{ background: "#211c19", color: "#f4f1ec", padding: "0 28px 62px" }}>
        <div style={{ margin: "0 auto", maxWidth: 1180, paddingTop: 56, display: "flex", alignItems: "flex-end", gap: 48, flexWrap: "wrap" }}>
          <div style={{ flex: "1 1 420px", minWidth: 0 }}>
            <p style={{ margin: 0, fontSize: 12, fontWeight: 500, letterSpacing: "0.2em", color: "#e9a396" }}>CALLCAITLYN LISTINGS · METRO ATLANTA</p>
            ...
            <p style={{ margin: "20px 0 0", fontSize: 17, lineHeight: 1.7, color: "#b3aaa0", maxWidth: "62ch" }}>
      ...
      <div className="om-gutter" style={{ margin: "0 auto", maxWidth: 1180, padding: "0 28px 96px" }}>
        <section id="listings" style={{ paddingTop: 64 }}>
          ...
          {available.length === 0 ? (
            ...
            <div style={{ marginTop: 26, display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(320px, 1fr))", gap: 16 }}>
                ...
                const body = (
                  <>
                    ...
                    <div style={{ padding: "20px 20px 22px", display: "flex", flexDirection: "column", gap: 14, flex: 1 }}>
                      ...
                      <p style={{ margin: 0, fontFamily: "var(--font-om-serif)", fontSize: 30, lineHeight: 1, color: "#211c19", borderTop: "1px solid #e4ddd2", paddingTop: 14 }}>
                        {listing.priceLabel}
                      </p>
                      {listing.cta && (
                        <p style={{ margin: "auto 0 0", paddingTop: 6, fontSize: 13, fontWeight: 600, letterSpacing: "0.08em", color: "#a33a29" }}>{listing.cta}</p>
                      )}
                    </div>
                  </>
                );
        ...
        {underContract.length > 0 && (
          <section id="under-contract" style={{ paddingTop: 72 }}>
            <div className="om-section-head" style={{ display: "flex", alignItems: "baseline", gap: 16, borderBottom: "1px solid #211c19", paddingBottom: 12, flexWrap: "wrap" }}>
        ...
        {sold.length > 0 && (
          <section id="sold" style={{ paddingTop: 72 }}>
        ...
        <section id="contact" style={{ paddingTop: 72 }}>
          <div style={{ borderTop: "2px solid #211c19", paddingTop: 26, display: "flex", gap: 40, flexWrap: "wrap", alignItems: "flex-start" }}>
            <div style={{ flex: 1, minWidth: 280 }}>
              <p style={{ margin: 0, fontSize: 12, fontWeight: 500, letterSpacing: "0.2em", color: "#a33a29" }}>WHO YOU&apos;RE WORKING WITH</p>
              <p style={{ margin: "16px 0 0", fontFamily: "var(--font-om-serif)", fontWeight: 600, fontSize: 30, lineHeight: 1.25, color: "#211c19", maxWidth: "20ch" }}>
                Caitlyn Verdugo, Keller Williams Metro Atlanta
              </p>
              <p style={{ margin: "14px 0 0", fontSize: 15, lineHeight: 1.7, color: "#574f47", maxWidth: "56ch" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10, minWidth: 230 }}>
              <Link
                ...
                style={{ display: "block", background: "#211c19", color: "#f4f1ec", textAlign: "center", padding: "15px 22px", fontSize: 13, fontWeight: 600, letterSpacing: "0.12em" }}
              >
                BOOK A CALL
              </Link>
              <a
              ...
              <p style={{ margin: "6px 0 0", fontSize: 13, color: "#6b6259", textAlign: "center" }}>cv.sellshomes@gmail.com</p>
            </div>
          </div>
        </section>
      </div>
